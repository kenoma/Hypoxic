...
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("REQUEST_ENABLE_BT");
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("REQUEST_TAGS_CHOOSEN");
            t.send(new HitBuilders.AppViewBuilder().build());
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("REQUEST_EXERCISE");
            t.send(new HitBuilders.AppViewBuilder().build());
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("REQUEST_RESULTS");
            t.send(new HitBuilders.AppViewBuilder().build());
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("REQUEST_SETTINGS");
            t.send(new HitBuilders.AppViewBuilder().build());
    ...
    private void GoToExercise()
    {
        ...
        interstitial.setAdUnitId( getString( R.string.intertestial_ad_unit_id));
    ...
    public void showDetailedInfo()
    {
        ...
        {
            Tracker t = this.getTracker(TrackerName.GLOBAL_TRACKER);
            t.setScreenName("showDetailedInfo");
            t.send(new HitBuilders.AppViewBuilder().build());
